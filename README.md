...
>
>POST /schedules/filter - ищет рейсы. на вход получает объект (см. ниже), на выходе массив Schedules по параметрам
> 
...
>
>POST /surveys/reports - возвращает краткий отчёт о количестве в категориях, получая на вход объект с полями "year" и "month"  
>
>POST /surveys/fullreports - возвращает полный отчёт, получая на вход объект с полями "year" и "month"
> 
