...
>
>POST /schedules/search - на вход получает объект (см. ниже), на выходе массив массивов, где каждый массив второго уровня - маршрут, содержащий от 1 до двух Schedules (см.ещё ниже)
